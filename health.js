    ...
    function updateCustomerId() {
		...
		const flexContainer = document.querySelector('.oj-flex');

		// 2. Create a new div with the Household ID block
		const householdDiv = document.createElement('div');
		householdDiv.className = 'oj-flex-item oj-sm-12';
		householdDiv.innerHTML = `
		  <div class="oj-sm-margin-2x">
			<span class="id-label">Household ID</span> 
			<span class="id-value oj-sm-margin-6x-start">HLD4567</span> 
		  </div>
		`;

		// 3. Decide where to insert
		// Example: insert Household ID just after Customer ID block
		const customerIdBlock = Array.from(flexContainer.querySelectorAll('.id-label'))
		  .find(el => el.textContent.trim() === 'Customer ID')
		  ?.closest('.oj-flex-item');

		if (customerIdBlock && customerIdBlock.nextSibling) {
		  flexContainer.insertBefore(householdDiv, customerIdBlock.nextSibling);
		} else {
		  // fallback: append at the end
		  flexContainer.appendChild(householdDiv);
		}
        ...
        <table style="width:100%; border-collapse:collapse; font-family:Arial, sans-serif; font-size:14px;">
          ...
          <tbody>
            <tr style="background-color:#fff;">
              ...
              <td style="padding:8px 12px; border:1px solid #ddd;">Term Plan</td>
            ...
            <tr style="background-color:#f9f9f9;">
              ...
              <td style="padding:8px 12px; border:1px solid #ddd;">Health Assure</td>
              <td style="padding:8px 12px; border:1px solid #ddd;">Active</td>
    ...
    function updateProductAffinity() {
        ...
        <table style="width:100%; border-collapse: collapse; font-family: Arial, sans-serif; font-size: 16px;">
          <tr style="border-bottom:1px solid #e0e0e0; background:#f4f6f7;">
            ...
            <td style="padding:12px; color:#E74C3C; font-weight:bold;">Term Plan</td>
          </tr>
          <tr>
